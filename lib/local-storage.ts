...
const initializeDefaultData = () => {
  ...
  const defaultProducts: Product[] = [
    ...
    },
    {
      ...
      description: "Carefully selected vintage wine from renowned vineyards",
      price: 299.99,
      originalPrice: 399.99,
      category: "Wines",
      brand: "Château Margaux",
      images: ["/placeholder.svg?height=300&width=300&text=Vintage+Wine"],
      inStock: true,
      stockQuantity: 20,
      badge: "Limited Edition",
      features: ["Aged to Perfection", "Premium Selection", "Gift Packaging", "Certificate Included"],
      specifications: { Vintage: "2018", Region: "Bordeaux", "Alcohol Content": "13.5%", Volume: "750ml" },
    ...
    },
    {
      ...
      description: "Premium body cream with anti-aging properties and natural ingredients",
      price: 89.99,
      originalPrice: 119.99,
      category: "Body Creams",
      brand: "La Mer",
      images: ["/placeholder.svg?height=300&width=300&text=Body+Cream"],
      inStock: true,
      stockQuantity: 35,
      badge: "Popular",
      features: ["Anti-Aging Formula", "Deep Moisturizing", "Natural Ingredients", "Dermatologist Tested"],
      specifications: { Volume: "200ml", "Skin Type": "All Types", "Key Ingredients": "Retinol, Hyaluronic Acid" },
  ...
  const defaultCategories: Category[] = [
    {
      id: 1,
      name: "Perfumes",
      description: "Luxury fragrances and designer perfumes",
    ...
    },
    {
      id: 3,
      name: "Cars",
      description: "Premium vehicles for sales and hire",
    ...
    },
    {
      id: 5,
      name: "Body Creams",
      description: "Luxury body creams and skincare products",
  ...
  const defaultNotifications: Notification[] = [
    ...
    },
    {
      ...
      message: "Luxury Designer Perfume is running low on stock (40 remaining)",
      type: "warning",
      isRead: false,
