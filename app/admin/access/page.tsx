...
export default function AdminAccessPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Admin Access Setup Required</h1>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="font-semibold text-yellow-800">Environment Configuration Required</h3>
        </div>
        <p className="text-yellow-700 mb-3">
          Your Supabase environment variables are not properly configured. Please set up the following:
        </p>
